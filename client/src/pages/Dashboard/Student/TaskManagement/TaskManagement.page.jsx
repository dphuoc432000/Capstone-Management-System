...
import TaskActivities from "../../../../components/TaskManagement/TaskActivities/TaskActivities.component";
...
function TaskManagement() {
  ...
  const openActivities = () => {
    if (isOpenedActivities) setIsOpenedActivities(false);
    else setIsOpenedActivities(true);
  };
