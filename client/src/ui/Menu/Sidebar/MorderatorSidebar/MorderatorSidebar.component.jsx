...
import styles from "./MorderatorSidebar.module.scss";
// components
...
const MorderatorSidebar = () => {
  return (
    ...
    >
      ...
      <NavLink className="base-link" to="/dashboard/student-management">
        <ListItemButton>
          <ListItemIcon>
...
export default MorderatorSidebar;
